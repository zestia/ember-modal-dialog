...
class kt{constructor(e,t){this.owner=e,this.isInteractive=t,this.enableDebugTooling=O.ENV._DEBUG_RENDER_TREE}onTransactionCommit(){}}var St=Pe((e=>{var{positional:t,named:r}=e,n=t[0],i=r.type,a=r.loc,o=r.original;(0,s.valueForRef)(i),(0,s.valueForRef)(a),(0,s.valueForRef)(o)
...
var n=O.get(e)
return void 0!==n&&O.set(r,n),r}var{toString:x}=Object.prototype,{toString:P}=Function.prototype,{isArray:C}=Array,{keys:A}=Object,{stringify:k}=JSON,S=100,j=/^[\w$]+$/
...
E(e,x[P]),m.push(C)}}e(82,T,t.EMPTY_STRING_ARRAY,O),m.push(-1)}else if(null!==l)for(var A=l[0],k=l[1],S=0;S<k.length;S++){var j=A[S],N=p.indexOf(j);-1!==N&&(E(e,k[S]),m.push(N),v.push(j))}e(97,r.$s0),(0,i.hasCapability)(a,64)&&e(59);(0,i.hasCapability)(a,512)&&e(87,0|c.has("default"),r.$s0)
...
for(var k=Object.keys(P),S=0;S<k.length;S++)i.push(P[k[S]])
...
return 2===arguments.length?(t=arguments[0],i=arguments[1],e=null):([e,t,n]=g(...arguments),void 0===n?i=0:s(i=n.pop())||(r=!0===i,i=n.pop())),[e,t,n,i=parseInt(i,10),r]}var y=0,_=0,w=0,O=0,E=0,T=0,R=0,x=0,P=0,C=0,A=0,k=0,S=0,j=0,M=0,N=0,I=0,D=0,F=0,L=0,U=0
class B{constructor(e,t){this.DEBUG=!1,this.currentInstance=null,this.instanceStack=[],this._eventCallbacks={end:[],begin:[]},this._timerTimeoutId=null,this._timers=[],this._autorun=!1,this._autorunStack=null,this.queueNames=e,this.options=t||{},"string"==typeof this.options.defaultQueue?this._defaultQueue=this.options.defaultQueue:this._defaultQueue=this.queueNames[0],this._onBegin=this.options.onBegin||m,this._onEnd=this.options.onEnd||m,this._boundRunExpiredTimers=this._runExpiredTimers.bind(this),this._boundAutorunEnd=()=>{F++,!1!==this._autorun&&(this._autorun=!1,this._autorunStack=null,this._end(!0))}
var r=this.options._buildPlatform||i
this._platform=r(this._boundAutorunEnd)}get counters(){return{begin:_,end:w,events:{begin:O,end:0},autoruns:{created:D,completed:F},run:E,join:T,defer:R,schedule:x,scheduleIterable:P,deferOnce:C,scheduleOnce:A,setTimeout:k,later:S,throttle:j,debounce:M,cancelTimers:N,cancel:I,loops:{total:L,nested:U}}}get defaultQueue(){return this._defaultQueue}begin(){_++
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=function(e){e.dataset.programmaticallyFocused="true",e.focus(),(0,t.next)((()=>delete e.dataset.programmaticallyFocused))}})),define("@zestia/ember-modal-dialog/components/modal-dialog",["exports","@ember/component","@ember/template-factory","@glimmer/component","ember-modifier","@glimmer/tracking","body-scroll-lock","rsvp","@ember/object","@ember/test-waiters","@zestia/animation-utils"],(function(e,t,r,n,i,a,s,o,u,l,c){"use strict"
var d,h,p,f
function m(e,t,r,n){r&&Object.defineProperty(e,t,{enumerable:r.enumerable,configurable:r.configurable,writable:r.writable,value:r.initializer?r.initializer.call(n):void 0})}function v(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}function g(e,t,r,n,i){var a={}
...
const b=(0,r.createTemplateFactory)({id:"XA5VZl3Y",block:'[[[11,0],[16,0,[28,[37,0],["modal-dialog"," modal-dialog--",[52,[30,0,["isShowing"]],"showing","hiding"],[52,[30,0,["isLoading"]]," modal-dialog--loading"]],null]],[17,1],[4,[38,2],["mousedown",[30,0,["handleMouseDown"]]],null],[4,[38,2],["mouseup",[30,0,["handleMouseUp"]]],null],[4,[30,0,["registerElement"]],null,null],[12],[1,"\\n  "],[11,0],[16,0,[28,[37,0],["modal-dialog__box",[52,[51,[30,0,["isInViewport"]]]," modal-dialog__box--exceeds-viewport"]],null]],[24,"role","dialog"],[24,"aria-modal","true"],[4,[30,0,["registerBoxElement"]],null,null],[4,[30,0,["notifyRoot"]],null,null],[4,[30,0,["bodyScrollLock"]],null,null],[4,[30,0,["inViewport"]],null,null],[4,[30,0,["trapFocus"]],null,null],[4,[30,0,["externalFocus"]],null,null],[4,[30,0,["internalFocus"]],null,null],[4,[30,0,["escapable"]],null,null],[12],[1,"\\n    "],[18,2,[[30,0,["api"]]]],[1,"\\n  "],[13],[1,"\\n"],[13]],["&attrs","&default"],false,["concat","if","on","unless","yield"]]',moduleName:"@zestia/ember-modal-dialog/components/modal-dialog.hbs",isStrictMode:!1})
let y=(d=class extends n.default{constructor(){super(...arguments),v(this,"element",null),v(this,"boxElement",null),v(this,"lastMouseDownElement",null),m(this,"isInViewport",h,this),m(this,"isLoading",p,this),m(this,"isShowing",f,this),v(this,"registerElement",(0,i.modifier)((e=>{this.element=e}),{eager:!1})),v(this,"registerBoxElement",(0,i.modifier)((e=>{this.boxElement=e}),{eager:!1})),v(this,"notifyRoot",(0,i.modifier)((()=>{const e=document.querySelector(":root")
return e.classList.add("has-modal"),()=>e.classList.remove("has-modal")}),{eager:!1})),v(this,"bodyScrollLock",(0,i.modifier)((e=>((0,s.disableBodyScroll)(e,{reserveScrollBarGap:!0,allowTouchMove:e=>{for(;this.boxElement.contains(e);){if(e.scrollHeight>e.clientHeight)return!0
...
return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)}),{eager:!1})),this.args.onReady?.(this.api),this.shouldLoad&&this._load()}get shouldLoad(){return"function"==typeof this.args.onLoad}get api(){return{close:this.close,isLoading:this.isLoading,element:this.element,boxElement:this.boxElement}}get containsModal(){return!!this.boxElement.querySelector(".modal-dialog")}async close(){this.isShowing=!1,await this._waitForAnimation(),this.args.onClose?.()}handleMouseDown(e){this.lastMouseDownElement=e.target}handleMouseUp(e){this.lastMouseDownElement===this.element&&this._escape(e)}_escape(e){this.args.onEscape?.(this.api,e)}async _load(){try{const e=await this.args.onLoad()
this.args.onLoaded?.(e)}catch(e){this.args.onLoadError?.(e)}finally{this.isLoading=!1}}_waitForAnimation(){return(0,o.all)([(0,c.waitForAnimation)(this.element),(0,c.waitForAnimation)(this.boxElement)])}},h=g(d.prototype,"isInViewport",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),p=g(d.prototype,"isLoading",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return this.shouldLoad}}),f=g(d.prototype,"isShowing",[a.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!0}}),g(d.prototype,"close",[u.action],Object.getOwnPropertyDescriptor(d.prototype,"close"),d.prototype),g(d.prototype,"handleMouseDown",[u.action],Object.getOwnPropertyDescriptor(d.prototype,"handleMouseDown"),d.prototype),g(d.prototype,"handleMouseUp",[u.action],Object.getOwnPropertyDescriptor(d.prototype,"handleMouseUp"),d.prototype),g(d.prototype,"_waitForAnimation",[l.waitFor],Object.getOwnPropertyDescriptor(d.prototype,"_waitForAnimation"),d.prototype),d)
