...
var r=Ember._setComponentTemplate(t,Ember._templateOnlyComponent())
e.default=r})),define("@zestia/ember-modal-dialog/components/modal-dialog/index",["exports","@glimmer/component","@zestia/ember-modal-dialog/components/modal-dialog/header","@zestia/ember-modal-dialog/components/modal-dialog/content","@zestia/ember-modal-dialog/components/modal-dialog/footer","body-scroll-lock","@ember/test-waiters","@zestia/animation-utils"],(function(e,t,r,n,i,a,s,o){"use strict"
var l,u,c,d,h,p,f,m,v,g,b,y,_,E,w,O,R,T,C
function S(e,t,r,n){r&&Object.defineProperty(e,t,{enumerable:r.enumerable,configurable:r.configurable,writable:r.writable,value:r.initializer?r.initializer.call(n):void 0})}function P(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}function k(e,t,r,n,i){var a={}
...
const x=Ember.HTMLBars.template({id:"XAh1H5/X",block:'[[[11,0],[16,0,[28,[37,0],["modal-dialog ","modal-dialog--",[52,[30,0,["isShowing"]],"showing","hiding"],[52,[30,0,["isWarning"]]," modal-dialog--warning"],[52,[30,0,["isLoading"]]," modal-dialog--loading"],[52,[51,[30,0,["inViewport"]]]," modal-dialog--exceeds-viewport"]],null]],[24,"role","dialog"],[24,"tabindex","0"],[24,"aria-modal","true"],[17,1],[4,[38,3],[[30,0,["handleInsertElement"]]],null],[4,[38,4],[[30,0,["handleDestroyElement"]]],null],[4,[38,5],["mousedown",[30,0,["handleMouseDown"]]],null],[4,[38,5],["mouseup",[30,0,["handleMouseUp"]]],null],[4,[38,5],["keydown",[30,0,["handleKeyDown"]]],null],[12],[1,"\\n  "],[11,0],[24,0,"modal-dialog__box"],[4,[38,3],[[30,0,["handleInsertBoxElement"]]],null],[12],[1,"\\n    "],[18,2,[[30,0,["api"]]]],[1,"\\n  "],[13],[1,"\\n"],[13]],["&attrs","&default"],false,["concat","if","unless","did-insert","will-destroy","on","yield"]]',moduleName:"@zestia/ember-modal-dialog/components/modal-dialog/index.hbs",isStrictMode:!1})
let A=(l=Ember._tracked,u=Ember._tracked,c=Ember._tracked,d=Ember._tracked,h=Ember._tracked,p=Ember._action,f=Ember._action,m=Ember._action,v=Ember._action,g=Ember._action,b=Ember._action,y=Ember._action,_=Ember._action,E=class extends t.default{constructor(){super(...arguments),P(this,"lastFocusedExternalElement",null),P(this,"lastFocusedInternalElement",null),P(this,"element",null),P(this,"lastMouseDownElement",null),P(this,"mutationObserver",null),P(this,"rootElement",null),P(this,"window",null),P(this,"ModalDialogContent",n.default),P(this,"ModalDialogFooter",i.default),P(this,"ModalDialogHeader",r.default),S(this,"boxElement",w,this),S(this,"inViewport",O,this),S(this,"isLoading",R,this),S(this,"isShowing",T,this),S(this,"isWarning",C,this),this.rootElement=document.querySelector(":root"),this.window=window,this.lastFocusedExternalElement=document.activeElement,this._load()}get api(){return{boxElement:this.boxElement,close:this.close,Content:this.ModalDialogContent,Footer:this.ModalDialogFooter,Header:this.ModalDialogHeader,isLoading:this.isLoading}}get focusableElements(){return[...this.element.querySelectorAll('\n        a[href],\n        button:not(:disabled),\n        textarea:not(:disabled),\n        input:not(:disabled),\n        select:not(:disabled),\n        [tabindex="0"],\n        [contenteditable="true"]\n      ')]}get firstFocusableElement(){return this.focusableElements[0]}get lastFocusableElement(){return this.focusableElements[this.focusableElements.length-1]}async close(){var e,t
await this._hide(),this._focus(this.lastFocusedExternalElement),null===(e=(t=this.args).onClose)||void 0===e||e.call(t)}_hide(){return this.isShowing=!1,this._waitForAnimation()}async warn(){this.isWarning=!0,await this._waitForAnimation(),this.isWarning=!1}handleKeyDown(e){this._pressedEscape(e)?this._attemptEscape():this._pressedTab(e)&&this._trapFocus(e)}handleMouseDown(e){this.lastMouseDownElement=e.target}handleMouseUp(){this.lastMouseDownElement===this.element&&this._attemptEscape()}handleInsertElement(e){this.element=e,this.element.focus(),this.rootElement.classList.add("has-modal"),this._disableBodyScroll(),this._startMonitoringContent(),this._startMonitoringViewport(),this._handleContentChanged(),this._ready()}handleDestroyElement(){this._enableBodyScroll(),this._stopMonitoringContent(),this._stopMonitoringViewport(),this.rootElement.classList.remove("has-modal")}handleInsertBoxElement(e){this.boxElement=e}_ready(){var e,t
null===(e=(t=this.args).onReady)||void 0===e||e.call(t,this.api)}async _load(){this.isLoading=!0
try{var e,t,r,n
...
null===(i=(a=this.args).onLoadError)||void 0===i||i.call(a,s)}finally{this.isLoading=!1}}_startMonitoringContent(){this.mutationObserver=new MutationObserver(this._handleContentChanged.bind(this)),this.mutationObserver.observe(this.element,{childList:!0,subtree:!0})}_stopMonitoringContent(){this.mutationObserver.disconnect()}_handleContentChanged(){Ember.run.scheduleOnce("afterRender",this,"_checkInViewport")}_startMonitoringViewport(){this.winResizeListener=this._handleResizedWindow.bind(this),this.winFocusListener=this._handleFocusedWindow.bind(this),this.winBlurListener=this._handleBlurredWindow.bind(this),this.window.addEventListener("resize",this.winResizeListener),this.window.addEventListener("focus",this.winFocusListener),this.window.addEventListener("blur",this.winBlurListener)}_stopMonitoringViewport(){this.window.removeEventListener("resize",this.winResizeListener),this.window.removeEventListener("focus",this.winFocusListener),this.window.removeEventListener("blur",this.winBlurListener)}_handleResizedWindow(){Ember.run.debounce(this,"_checkInViewport",100)}_handleBlurredWindow(){this.lastFocusedInternalElement=document.activeElement}_handleFocusedWindow(){this._focus(this.lastFocusedInternalElement)}_checkInViewport(){this.isDestroying||this.isDestroyed||(this.inViewport=this._inViewport(this.boxElement))}_inViewport(e){const t=e.getBoundingClientRect(),r=this.window
return t.top>0&&t.left>0&&t.bottom<r.innerHeight&&t.right<r.innerWidth}_disableBodyScroll(){(0,a.disableBodyScroll)(this.element,{reserveScrollBarGap:!0,allowTouchMove:this._allowTouchMove.bind(this)})}_enableBodyScroll(){(0,a.enableBodyScroll)(this.element)}_allowTouchMove(e){return this.boxElement.contains(e)}_pressedEscape(e){return 27===e.keyCode}_pressedTab(e){return 9===e.keyCode}_tabbedToEnd(e){return!e.shiftKey&&document.activeElement===this.lastFocusableElement}_tabbedToStart(e){return e.shiftKey&&document.activeElement===this.firstFocusableElement}_trapFocus(e){this._tabbedToStart(e)?(this.lastFocusableElement.focus(),e.preventDefault()):this._tabbedToEnd(e)&&(this.firstFocusableElement.focus(),e.preventDefault())}_focus(e){try{e.focus()}catch(t){}}_attemptEscape(){this.args.escapable?this.close():this.warn()}async _waitForAnimation(){await Ember.RSVP.all([(0,o.waitForAnimation)(this.element),(0,o.waitForAnimation)(this.boxElement)])}},w=k(E.prototype,"boxElement",[l],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),O=k(E.prototype,"inViewport",[u],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),R=k(E.prototype,"isLoading",[c],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),T=k(E.prototype,"isShowing",[d],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!0}}),C=k(E.prototype,"isWarning",[h],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),k(E.prototype,"close",[p],Object.getOwnPropertyDescriptor(E.prototype,"close"),E.prototype),k(E.prototype,"warn",[f],Object.getOwnPropertyDescriptor(E.prototype,"warn"),E.prototype),k(E.prototype,"handleKeyDown",[m],Object.getOwnPropertyDescriptor(E.prototype,"handleKeyDown"),E.prototype),k(E.prototype,"handleMouseDown",[v],Object.getOwnPropertyDescriptor(E.prototype,"handleMouseDown"),E.prototype),k(E.prototype,"handleMouseUp",[g],Object.getOwnPropertyDescriptor(E.prototype,"handleMouseUp"),E.prototype),k(E.prototype,"handleInsertElement",[b],Object.getOwnPropertyDescriptor(E.prototype,"handleInsertElement"),E.prototype),k(E.prototype,"handleDestroyElement",[y],Object.getOwnPropertyDescriptor(E.prototype,"handleDestroyElement"),E.prototype),k(E.prototype,"handleInsertBoxElement",[_],Object.getOwnPropertyDescriptor(E.prototype,"handleInsertBoxElement"),E.prototype),k(E.prototype,"_waitForAnimation",[s.waitFor],Object.getOwnPropertyDescriptor(E.prototype,"_waitForAnimation"),E.prototype),E)
e.default=A,Ember._setComponentTemplate(x,A)})),define("ember-load-initializers/index",["exports","require"],(function(e,t){"use strict"
