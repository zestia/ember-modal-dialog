...
return null===(t=(r=this.args).onLoadError)||void 0===t?void 0:t.call(r,e)})).finally((()=>this.isLoading=!1))}_startMonitoringContent(){this.mutationObserver=new MutationObserver(this._contentChanged.bind(this)),this.mutationObserver.observe(this.element,{childList:!0,subtree:!0}),this._contentChanged()}_stopMonitoringContent(){this.mutationObserver.disconnect()}_contentChanged(){Ember.run.scheduleOnce("afterRender",this,"_checkInViewport")}_startMonitoringViewport(){this.resizeListener=this._viewportChanged.bind(this),this.window.addEventListener("resize",this.resizeListener)}_stopMonitoringViewport(){this.window.removeEventListener("resize",this.resizeListener)}_viewportChanged(){Ember.run.debounce(this,"_checkInViewport",100)}_checkInViewport(){this.isDestroying||this.isDestroyed||(this.inViewport=this._inViewport(this.boxElement))}_inViewport(e){const t=e.getBoundingClientRect(),r=this.window
