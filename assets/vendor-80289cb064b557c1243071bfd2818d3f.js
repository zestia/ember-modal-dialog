...
return r.observe(e,{childList:!0,subtree:!0}),window.addEventListener("resize",t),t(),()=>{r.disconnect(),window.addEventListener("resize",t)}}))),g(this,"trapFocus",(0,r.modifier)((e=>{const t=t=>{if(this.containsModal||"Tab"!==t.key)return
