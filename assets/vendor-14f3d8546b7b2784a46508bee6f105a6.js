...
const y=Ember.HTMLBars.template({id:"NCp2e361",block:'[[[11,0],[16,0,[28,[37,0],["modal-dialog"," modal-dialog--",[52,[30,0,["isShowing"]],"showing","hiding"],[52,[30,0,["isLoading"]]," modal-dialog--loading"]],null]],[17,1],[4,[38,2],["mousedown",[30,0,["handleMouseDown"]]],null],[4,[38,2],["mouseup",[30,0,["handleMouseUp"]]],null],[4,[30,0,["registerElement"]],null,null],[12],[1,"\\n  "],[11,0],[16,0,[28,[37,0],["modal-dialog__box",[52,[51,[30,0,["isInViewport"]]]," modal-dialog__box--exceeds-viewport"]],null]],[24,"role","dialog"],[24,"tabindex","0"],[24,"aria-modal","true"],[4,[30,0,["registerBoxElement"]],null,null],[4,[30,0,["notifyRoot"]],null,null],[4,[30,0,["bodyScrollLock"]],null,null],[4,[30,0,["inViewport"]],null,null],[4,[30,0,["trapFocus"]],null,null],[4,[30,0,["externalFocus"]],null,null],[4,[30,0,["internalFocus"]],null,null],[4,[30,0,["escapable"]],null,null],[4,[38,4],null,null],[12],[1,"\\n    "],[18,2,[[30,0,["api"]]]],[1,"\\n  "],[13],[1,"\\n"],[13]],["&attrs","&default"],false,["concat","if","on","unless","auto-focus","yield"]]',moduleName:"@zestia/ember-modal-dialog/components/modal-dialog.hbs",isStrictMode:!1})
...
return r.observe(e,{childList:!0,subtree:!0}),window.addEventListener("resize",t),t(),()=>{r.disconnect(),window.removeEventListener("resize",t)}}))),g(this,"trapFocus",(0,r.modifier)((e=>{const t=t=>{if(this.containsModal||"Tab"!==t.key)return
...
return()=>{try{e.focus()}catch(t){}}}))),g(this,"escapable",(0,r.modifier)((()=>{const e=e=>{this.containsModal||"Escape"!==e.key||this._escape(e)}
return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)}))),null===(e=(t=this.args).onReady)||void 0===e||e.call(t,this.api),this._load()}get api(){return{close:this.close,isLoading:this.isLoading,element:this.element,boxElement:this.boxElement}}get containsModal(){return!!this.boxElement.querySelector(".modal-dialog")}async close(){var e,t
